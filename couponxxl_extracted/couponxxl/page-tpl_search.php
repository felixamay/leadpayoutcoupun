                        ...
                        <?php if( !empty( $pagination ) ): ?>
                            <div class="pagination-wrap">
                                ...
                                <div class="pagination-info">
                                    <strong><?php echo wp_kses_post( ( $cur_page - 1 ) * $offers_per_page + 1 ); ?></strong> - <strong><?php echo wp_kses_post( ( $cur_page - 1 ) * $offers_per_page + $offers->post_count ); ?></strong>
                                    <?php esc_html_e( 'of', 'couponxxl' ) ?>
                                    <strong><?php echo wp_kses_post( $offers->found_posts ); ?></strong>
