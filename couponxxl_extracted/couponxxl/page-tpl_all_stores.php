					...
					<div class="row">
						<div class="col-md-12">
							<div class="white-block filter-block">
								...
								<h5>Filter by keyword: <strong><?php echo wp_kses_post( $keyword ); ?></strong></h5>
							</div>
						</div>
					</div>
				<?php endif; ?>
				...
				if ( ! empty( $pagination ) ) {
					...
					<div class="pagination-wrap">
						...
						<div class="pagination-info">
							<strong><?php echo wp_kses_post( ( $cur_page - 1 ) * $stores_per_page + 1 ); ?></strong> -
							<strong><?php echo wp_kses_post( ( $cur_page - 1 ) * $stores_per_page + $stores->post_count ); ?></strong>
