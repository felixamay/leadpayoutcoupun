jQuery(document).ready(function($){
	...
	if( $('select[id^="offer_type-sm-field"]').length > 0 ){
		...
		common.before(
			'<a href="javascript:;" class="button button-primary button-large offer_toggle_options" data-target="#'+common.attr('id')+'">'+common.find('.hndle').text()+'</a>'+
			'<a href="javascript:;" class="button button-large offer_toggle_options hide-btn coupon" data-target="#'+coupon.attr('id')+'">'+coupon.find('.hndle').text()+'</a>'+
			'<a href="javascript:;" class="button button-large offer_toggle_options hide-btn deal" data-target="#'+deal.attr('id')+'">'+deal.find('.hndle').text()+'</a>'+
			'<a href="javascript:;" class="button button-large offer_toggle_options '+extra_class+'" data-target="#'+requests.attr('id')+'">'+requests.find('.hndle').text()+'</a>'
		);
