                    ...
                    <div class="col-sm-9">
                        ...
                        if( !empty( $letters ) ){
                            ...
                            foreach( $letters as $letter_item ){
                                ?>
                                <a href="<?php echo esc_url( couponxxl_append_query_string( $this_permalink, array( $couponxxl_slugs['letter'] => $letter_item ) ) ) ?>" class="<?php echo ( isset( $letter ) && $letter == $letter_item ) ? esc_attr('active') : esc_attr('') ?>">
                                        ...
                                        <?php foreach( $offer_cats as $cat ): ?>
                                            ...
                                            <li>
                                                <a href="<?php echo esc_url( couponxxl_append_query_string( $permalink, array( $couponxxl_slugs['offer_cat'] => $cat->slug ) ) ); ?>">
                                                    ...
                                                    <span class="count"><?php echo wp_kses_post( $offer_count ); ?></span>
                                                </a>
                                            </li>
                                        <?php endforeach; ?>
                                    </ul>
                                ...
                                <div class="white-block">
                                    <div class="white-block-content">
                                        <a href="<?php echo esc_url( couponxxl_append_query_string( $permalink, array( $couponxxl_slugs['offer_cat'] => $offer_cat->slug ) ) ); ?>" class="lead-category">
                                            <?php echo wp_kses_post( $offer_cat->name ); ?>
                                            <span class="count"><?php echo wp_kses_post( $offer_count ); ?></span>
                                        </a>
