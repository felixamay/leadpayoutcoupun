                    ...
                    <div class="white-block-media">
                        <ul class="list-unstyled deal-img-slider">
							...
							if ( has_post_thumbnail() ) {
								...
								echo '<li><img src="' . esc_url( get_template_directory_uri() . '/images/slider-featured-placeholder.png' ) . '" /></li>';
							}
                    ...
                    <div class="white-block-content">
                        ...
                        <div class="deal-single-add-to-cart">
							...
							if ( empty( $deal_link ) ) {
								...
								?>
                                <a href="<?php echo esc_url( add_query_arg( array( 'rd' => get_the_ID() ) ) ) ?>"
                                   class="btn" rel="nofollow"><?php esc_html_e( 'Visit Deal', 'couponxxl' ) ?></a>
								<?php
							} ?>
                        </div>
                                ...
                                <div class="groupon-info text-center">
                                    <h5>
                                        <a href="#groupon_explanation" data-toggle="modal">
											<?php $sales_needed = $deal_min_sales - $deal_sales; ?>
											<?php printf( translate_nooped_plural( _n_noop( '%s more sale required', '%s more sales needed', 'couponxxl' ), $sales_needed, 'couponxxl' ), $sales_needed ); ?>
                                        </a>
                                    </h5>
                                </div>
								<?php
                        ...
                        <ul class="list-unstyled list-inline store-social-networks">
                            ...
                            <li>
                                <a href="javascript:;" class="share mail-share" data-body="<?php the_permalink(); ?>"
...
<script type="application/ld+json">
{
  ...
  "description": "<?php echo wp_kses_post( $excerpt ); ?>",
  "offers": {
    "@type": "Offer",
    "priceCurrency": "<?php echo esc_attr( couponxxl_get_option( 'main_unit_abbr' ) ) ?>",
    "price": "<?php echo wp_kses_post( $deal_sale_price ) ?>",
