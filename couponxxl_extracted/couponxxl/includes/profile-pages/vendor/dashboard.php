<div class="white-block">
	<div class="white-block-content">
		...
		<ul class="list-unstyled dashboard-stats">
			<li>
				<i class="fa fa-tags"></i><?php esc_html_e( 'Coupons:', 'couponxxl' ) ?> <span class="badge"><?php echo wp_kses_post( $coupons ); ?></span>
			</li>
			<li>
				<i class="fa fa-hand-o-right"></i><?php esc_html_e( 'Deals:', 'couponxxl' ) ?> <span class="badge"><?php echo wp_kses_post( $deals ); ?></span>
			</li>
			<li>
				<i class="fa fa-bar-chart"></i><?php esc_html_e( 'Sales:', 'couponxxl' ) ?> <span class="badge"><?php echo wp_kses_post( $sales ); ?></span>
			</li>
