...
<div>
    ...
    <div class="input-group">
        ...
        <textarea type="text" name="deal_excerpt" id="deal_excerpt" class="form-control"><?php echo wp_kses_post( $deal_excerpt ); ?></textarea>
...
<div>
    ...
    <div class="input-group">
        ...
        <select name="deal_type" id="deal_type" class="form-control" data-validation="required" data-error="<?php _e( 'Select deal type', 'couponxxl' ); ?>" data-shared="<?php echo couponxxl_get_option( 'deal_owner_price_shared' ) ?>" data-not_shared="<?php echo couponxxl_get_option( 'deal_owner_price_not_shared' ) ?>" data-unit="<?php echo couponxxl_get_option( 'unit' ) ?>" data-unit_position="<?php echo couponxxl_get_option( 'unit_position' ) ?>">
            ...
            <option value="shared" <?php echo 'shared' == $deal_type ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'Website Offer', 'couponxxl' ) ?></option>
            <option value="not_shared" <?php echo 'not_shared' == $deal_type ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'Store Offer', 'couponxxl' ) ?></option>
        </select>
        <div class="alert alert-info shared_info <?php echo 'shared' == $deal_type ? esc_attr( '' ) : esc_attr( 'hidden' ) ?>">
        ...
        <div class="alert alert-info not_shared_info <?php echo 'not_shared' == $deal_type ? esc_attr( '' ) : esc_attr( 'hidden' ) ?>">
