...
<div class="widget white-block widget_couponxxl_filter">
    ...
    <form action="<?php echo esc_url( home_url( '/' . $wp->request ) ) ?>" class="advanced-search">
    ...
    <div class="category-filter">
        ...
        ?>
            <div class="widget-title">
                <h4>
                    <?php echo wp_kses_post( $search_page_category_filter_title ); ?>
                </h4>
            </div>
        <?php endif; ?>
        <?php
    ...
    <?php if( $offer_type == 'deal' ): ?>
        <div class="location-filter">
            ...
            ?>
                <div class="widget-title">
                    <h4>
                        <?php echo wp_kses_post( $search_page_location_filter_title ); ?>
                    </h4>
                </div>
            <?php endif; ?>
    ...
    <div class="store-filter">
        ...
        ?>
            <div class="widget-title">
                <h4>
                    <?php echo wp_kses_post( $search_page_store_filter_title ); ?>
                </h4>
            </div>
        <?php endif; ?>
        <ul class="list-unstyled">
    ...
    ?>
        <div class="offer-type-filter">
            ...
            ?>
                <div class="widget-title">
                    <h4>
                        <?php echo wp_kses_post( $search_page_offer_type_filter_title ); ?>
                    </h4>
                </div>
            <?php endif; ?>
            <ul class="list-unstyled">
                ...
                <li>
                    <input type="radio" name="<?php echo esc_attr( $couponxxl_slugs['offer_type'] ); ?>" id="deal" value="deal" <?php echo 'deal' == $offer_type ? 'checked="checked"' : '' ?>>
                    <label for="deal"><?php esc_html_e( 'Deals Only', 'couponxxl' ) ?></label>
                </li>
                <li>
                    <input type="radio" name="<?php echo esc_attr( $couponxxl_slugs['offer_type'] ); ?>" id="coupon" value="coupon" <?php echo 'coupon' == $offer_type ? 'checked="checked"' : '' ?>>
