(function($) {
	...
	if( typeof tinymce != 'undefined' ){
	    tinymce.create('tinymce.plugins.couponxxl', {
	        init : function(ed, url) {
	        	instance = ed;        	
				ed.addButton('couponxxlgrid', {
					type: 'listbox',
					text: 'CouponXXL Grid',
					icon: false,
					onselect: function(e) {
				...
				/* elements */
				ed.addButton('couponxxlelements', {
					type: 'listbox',
					text: 'CouponXXL Elements',
					icon: false,
					onselect: function(e) {
						active_shortcode = this.value();
						call_shortcode();
					...
					values: [
						...
						{ text: 'Title With Link', value: 'title_link' },
						{ text: 'Toogle', value: 'toggle' },
					],
					onPostRender: function() {
						ed.my_control = this;
					}
	    ...
	    // Register plugin
	    tinymce.PluginManager.add( 'couponxxl', tinymce.plugins.couponxxl );
	}
})(jQuery);
