<div class="input-group">
    ...
    <textarea name="coupon_excerpt" id="coupon_excerpt" class="form-control"><?php echo wp_kses_post( $coupon_excerpt ); ?></textarea>
...
<div class="input-group">
    ...
    <select name="coupon_type" id="coupon_type" class="form-control" data-validation="required" data-error="<?php _e( 'Select coupon type', 'couponxxl' ); ?>">
    	...
    	<option value="code" <?php echo 'code' == $coupon_type ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'Code', 'couponxxl' ) ?></option>
    	<option value="sale" <?php echo 'sale' == $coupon_type ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'Sale', 'couponxxl' ) ?></option>
    	<option value="printable" <?php echo 'printable' == $coupon_type ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'Printable', 'couponxxl' ) ?></option>
    </select>
    <p class="description"><?php esc_html_e( 'Choose type of the coupon.', 'couponxxl' ); ?></p>
</div>

<div class="input-group group_code_type group_code <?php echo 'code' == $coupon_type ? esc_attr( '' ) : esc_attr( 'hidden' ); ?>">
...
<div class="input-group group_code_type group_sale <?php echo 'sale' == $coupon_type ? esc_attr( '' ) : esc_attr( 'hidden' ); ?>">
...
<div class="input-group group_code_type group_printable <?php echo 'printable' == $coupon_type ? esc_attr( '' ) : esc_attr( 'hidden' ); ?>">
