			...
			$this->sections[] = array(
				...
				'fields'     => array(
                    array(
                        ...
                        'title'   => esc_html__( 'Is Demo?', 'couponxxl' ),
                        'desc'    => esc_html__( 'Select if it is a demo version of the site', 'couponxxl' ),
                        'default' => 'no'
                    ),
					array(
						'id'      => 'theme_usage',
			...
			$this->sections[] = array(
				...
				'fields'     => array(
                    array(
                        'id'       => 'default_status',
                        'type'     => 'select',
                        'title'    => esc_html__( 'Default Offer Status', 'couponxxl' ),
                        'compiler' => 'true',
                        'options'  => array(
                            'live'  => esc_html__( 'Live', 'couponxxl' ),
                            'pending' => esc_html__( 'Pending', 'couponxxl' )
                        ),
                        'desc'     => esc_html__( 'Choose the default status of the submitted offers.', 'couponxxl' ),
                        'default'  => 'pending'
                    ),
					array(
						'id'       => 'unlimited_expire',
			...
			$this->sections[] = array(
				...
				'fields' => array(
					array(
						...
						'desc'     => esc_html__( 'Select the main font for the theme.', 'couponxxl' ),
						'default'  => 'Inter'
					),
					array(
						'id'       => 'text_font',
						'type'     => 'select',
						'title'    => esc_html__( 'Body Text Font', 'couponxxl' ),
						'compiler' => 'true',
						'options'  => couponxxl_google_fonts(),
						'desc'     => esc_html__( 'Select font for body text and paragraphs.', 'couponxxl' ),
						'default'  => 'Inter'
					),
					array(
						'id'       => 'titles_font',
						'type'     => 'select',
						'title'    => esc_html__( 'Titles Font', 'couponxxl' ),
						'compiler' => 'true',
						'options'  => couponxxl_google_fonts(),
						'desc'     => esc_html__( 'Select font for headings and titles.', 'couponxxl' ),
						'default'  => 'Poppins'
					),
					array(
						'id'       => 'navigation_font',
						'type'     => 'select',
						'title'    => esc_html__( 'Navigation Font', 'couponxxl' ),
						'compiler' => 'true',
						'options'  => couponxxl_google_fonts(),
						'desc'     => esc_html__( 'Select font for navigation menu items.', 'couponxxl' ),
						'default'  => 'Poppins'
					),
					array(
						'id'          => 'body_background',
