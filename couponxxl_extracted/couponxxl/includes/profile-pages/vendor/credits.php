					...
					<div class="white-block credit-package">
						<div class="white-block-content">
							<div class="package-title">
								<?php echo wp_kses_post( $temp[0] ).' '.( $temp[0] == 1 ? esc_html__( 'credit', 'couponxxl' ) : esc_html__( 'credits', 'couponxxl' ) ).' '.esc_html__( 'for', 'couponxxl' ).' '.$price_basic ?>
							</div>
							<div class="package-value">
								<span><?php echo wp_kses_post( $temp[0] ); ?><span><?php esc_html_e( 'c', 'couponxxl' ) ?></span></span> = <span><?php echo wp_kses_post( $price ); ?></span>
							</div>
